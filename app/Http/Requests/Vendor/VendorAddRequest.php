...
class VendorAddRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'pin_code.required' => translate('The_pin_code_field_is_required'),
            ...
            'city.string' => translate('The_city_field_must_be_a_string'),
            'city.max' => translate('The_city_may_not_be_greater_than_100_characters'),
            'state.string' => translate('The_state_field_must_be_a_string'),
            'state.max' => translate('The_state_may_not_be_greater_than_50_characters'),
            'country.string' => translate('The_country_field_must_be_a_string'),
            'country.max' => translate('The_country_may_not_be_greater_than_100_characters'),
        ];
    }
