...
<head>
    ...
    @if (url()->current() == 'https://healthandblossom.com')
        ...
        <meta name="description"
            content="Shop Health and Blossom for the finest organic products! Discover a wide range of natural foods, beauty essentials, and wellness items, all sourced for quality and sustainability. Embrace a healthier lifestyle today!">
        <meta name="og:description"
            content="Shop Health and Blossom for the finest organic products! Discover a wide range of natural foods, beauty essentials, and wellness items, all sourced for quality and sustainability. Embrace a healthier lifestyle today!">
        <meta name="og:type" content="">
        <meta name="og:image"
            content="https://healthandblossom.com/public/assets/back-end/company/2024-09-20-66ed3608c0209.webp">
    @else
    ...
    <meta name="twitter:description"
        content="Shop Health and Blossom for the finest organic products! Discover a wide range of natural foods, beauty essentials, and wellness items, all sourced for quality and sustainability. Embrace a healthier ">
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('public/assets/back-end/company/') . '/' . $web_config['fav_icon']['key'] }}">
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            f.parentNode.insertBefore(j, f);
        })(window, document, 'script', 'dataLayer', 'GTM-NRPS5DT');
    </script>
    <!-- End Google Tag Manager -->
...
<body class="toolbar-enabled">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NRPS5DT" height="0" width="0"
        ...
        <div class="__floating-btn">
            ...
            @if (isset($whatsapp['status']) && $whatsapp['status'] == 1)
                <div class="wa-widget-send-button">
                    <a href="https://wa.me/{{ $whatsapp['phone'] }}?text=Hello There, If you have any questions or want to chat feel free to ask me anything. I am here to assist you."
                        target="_blank">
