                                                            ...
                                                            <div class="media-body">
                                                               ...
                                                               <br>
                                                                @if(!empty($detail->third_party_delivery_tracking_id) && !empty($detail->delivery_service_name))
                                                                  <small><a title="Track Your Order Here" target="_blank" href="https://www.delhivery.com/track/package/{{$detail->third_party_delivery_tracking_id}}">{{ucfirst($detail->delivery_service_name)}}:{{$detail->third_party_delivery_tracking_id}}</a></small>
                                                                @endif
