                    ...
                    <div class="card-body">
                        ...
                        <div class="border p-3 p-xl-4 rounded mt-4">
                            ...
                            <div class="form-group mb-1">
                                <label for="store_name" class="text-capitalize">{{translate('country')}} <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="country"  name="country" placeholder="{{translate('country')}}" required>
                            </div>

                            <div class="form-group mb-1">
                                <label for="store_name" class="text-capitalize">{{translate('state')}} <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="state"  name="state" placeholder="{{translate('state')}}" required>
                            </div>
                            <div class="form-group mb-1">
                                <label for="store_name" class="text-capitalize">{{translate('city')}} <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="city"  name="city" placeholder="{{translate('City')}}" required>
                            </div>

                            <div class="form-group mb-1">
                                <label for="store_name" class="text-capitalize">{{translate('pin_code')}} <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="pin_code"  name="pin_code" placeholder="{{translate('pin_code')}}" required>
                            </div>
