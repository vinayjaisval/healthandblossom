<aside class="col-lg-4 pt-4 pt-lg-2 px-max-md-0 order-summery-aside">
    <div class="__cart-total __cart-total_sticky">
        ...
        @endif
        @if(Request::url()=="https://healthandblossom.com/shop-cart" || Request::url()=="https://healthandblossom.com/shop-cart")
            <div class="pt-4">
                <a class="btn btn--primary btn-block  {{$cart->count() <= 0 ? 'disabled' : ''}} action-checkout-function">{{translate('proceed_to_Checkout')}}</a>
            </div>
       @elseif(Request::url()=="https://www.healthandblossom.com/checkout-details" || Request::url()=="https://www.healthandblossom.com/checkout-details")
            <div class="pt-4">
        ...
        @else
            <div class="pt-4">
                <a class="btn btn--primary btn-block  {{$cart->count() <= 0 ? 'disabled' : ''}} action-checkout-function">Place your order</a>
            </div>
