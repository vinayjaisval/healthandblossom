...
@if(isset($robotsMetaContentData) && $robotsMetaContentData?->keywords)
    <meta name="keywords" content="{{$robotsMetaContentData?->keywords}}">
	<meta name="og:keywords" content="{{$robotsMetaContentData?->keywords}}">
    <meta name="twitter:keywords" content="{{$robotsMetaContentData?->keywords}}">
@endif
