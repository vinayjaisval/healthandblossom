                    ...
                    <div class="text-center">
                        ...
                        <div class="__p-25-10 w-100 pt-4">
                            ...
                            <div class="filter-item">
                                <input class="filter-checkbox" type="checkbox" id="best-selling"
                                    value="{{ route('products',['id'=>$data['id'],'data_from'=>'best-selling','page'=>1]) }}"
                                    {{ isset($data['data_from']) && $data['data_from'] == 'best-selling' ? 'checked' : '' }}>
                            ...
                            <div class="filter-item">
                                <input class="filter-checkbox" type="checkbox" id="top-rated"
                                    value="{{ route('products',['id'=>$data['id'],'data_from'=>'top-rated','page'=>1]) }}"
                                    {{ isset($data['data_from']) && $data['data_from'] == 'top-rated' ? 'checked' : '' }}>
                            ...
                            <div class="filter-item">
                                <input class="filter-checkbox" type="checkbox" id="most-favorite"
                                    value="{{ route('products',['id'=>$data['id'],'data_from'=>'most-favorite','page'=>1]) }}"
                                    {{ isset($data['data_from']) && $data['data_from'] == 'most-favorite' ? 'checked' : '' }}>

                                <label for="most-favorite">
                                    {{ translate('most_favorite') }}
                                </label>
                            </div>

                            <div class="filter-item">
                                <input class="filter-checkbox" type="checkbox" id="featured-deal"
                                    value="{{ route('products',['id'=>$data['id'],'data_from'=>'featured_deal','page'=>1]) }}"
                                    {{ isset($data['data_from']) && $data['data_from'] == 'featured_deal' ? 'checked' : '' }}>

                                <label for="featured-deal">
