    ...
    <table class="table physical_product_show table-borderless">
        ...
        @foreach ($combinations as $key => $combination)
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="price_{{ $str }}" value="{{ isset($unitPrice['price_'.$str]) ? $unitPrice['price_'.$str] : '' }}" min="0" step="0.01"
                ...
                <td>
                    <input type="number" name="qty_{{ $str }}"  value="{{ isset($getQuantity['qty_'.$str]) ? $getQuantity['qty_'.$str] : '1' }}" min="1"
