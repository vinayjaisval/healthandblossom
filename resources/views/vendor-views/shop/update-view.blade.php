                    ...
                    <form action="{{route('vendor.shop.update',[$shop->id])}}" method="post" class="text-start"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                        <label for="city" class="title-color text-capitalize">{{ translate('city') }} <span class="text-danger">*</span></label>
                                        <input type="text" name="city" value="{{ $shop->city }}" class="form-control" id="city" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="state" class="title-color text-capitalize">{{ translate('state') }} <span class="text-danger">*</span></label>
                                        <input type="text" name="state" value="{{ $shop->state }}" class="form-control" id="state" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="country" class="title-color text-capitalize">{{ translate('country') }} <span class="text-danger">*</span></label>
                                        <input type="text" name="country" value="{{ $shop->country }}" class="form-control" id="country" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="pin_code" class="title-color text-capitalize">{{ translate('pin_code') }} <span class="text-danger">*</span></label>
                                        <input type="text" name="pin_code" value="{{ $shop->pin_code }}" class="form-control" id="pin_code" required>
                                    </div>
