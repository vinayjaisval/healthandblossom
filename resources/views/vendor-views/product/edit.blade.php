                    ...
                    <div class="row align-items-end">
                      ...
                      <div class="form-group">
                            ...
                            <select class="js-select2-custom form-control" name="hsn_code_under_gst" id="hsn_code_under_gst">
                                ...
                                @foreach ($hsncode as $hsnCode)
                                    <option value="{{ $hsnCode->hsn_code_under_gst }}" {{ $product->hsn_code_under_gst == $hsnCode->hsn_code_under_gst ? 'selected' : '' }}>{{ $hsnCode->hsn_code_under_gst." ".$hsnCode->description }}</option>
                                @endforeach
                            </select>
                        </div>
                        </div>
