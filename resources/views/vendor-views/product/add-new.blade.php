...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('vendor.products.add') }}" method="POST"
                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="how_to_use"
                                    class="summernote {{ $lang == $defaultLanguage ? 'product-how_to_use-default-language' : '' }}">{{ old('details') }}</textarea>
                            </div>
                            ...
                            <div class="form-group pt-2">
                                ...
                                <textarea class="summernote {{ $lang == $defaultLanguage ? 'product-ingredients-default-language' : '' }}"
                                    name="ingredients1">{{ old('features') }}</textarea>
                            </div>
                            <!-- Features -->
                            <div class="form-group pt-2">
                                ...
                                <textarea class="summernote {{ $lang == $defaultLanguage ? 'product-features-default-language' : '' }}"
                                    name="features">{{ old('features') }}</textarea>
                            </div>
                            <!-- Disclaimer -->
                            <div class="form-group pt-2">
                                ...
                                <textarea class="summernote {{ $lang == $defaultLanguage ? 'product-disclaimer-default-language' : '' }}"
                                    name="disclaimer">{{ old('disclaimer') }}</textarea>
                            </div>
                            <div class="form-group pt-2">
                                <label class="title-color" for="{{ $lang }}_return_policy">
                                    {{ translate('Return Policy') }} ({{ strtoupper($lang) }})
                                </label>
                                <textarea class="summernote {{ $lang == $defaultLanguage ? 'product-return_policy-default-language' : '' }}"
                                    name="return_policy">{{ old('disclaimer') }}</textarea>
                            </div>
                            <!-- Feature Key -->
                            <div class="form-group pt-2">
                                ...
                                <textarea class="summernote {{ $lang == $defaultLanguage ? 'product-feature_key-default-language' : '' }}"
                                    name="feature_key">{{ old('feature_key') }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange"
                                    name="category_id" id="categoryhsn_id"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="hsn_code_under_gst"
                                    id="hsn_code_under_gst" disabled>
            ...
            <div class="card mt-3 rest-part physi" style="display: none" id="whole_sale_section">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alt_tag" class="form-control"
                                    placeholder="{{ translate('enter_alt_tag') }}">
                            </div>
                        </div>
