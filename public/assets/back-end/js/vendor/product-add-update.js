...
function elementProductColorSwitcherByIDFunctionality() {
    if (elementProductColorSwitcherByID.prop('checked')) {
        ...
        choiceAttributes.val().trigger('change');
...
$('#choice_attributes').on('change', function () {
   ...
   if (choiceAttributes &&
        (Array.isArray(choiceAttributes) ? choiceAttributes.length > 0 : typeof choiceAttributes === 'object' && Object.keys(choiceAttributes).length > 0)) {
